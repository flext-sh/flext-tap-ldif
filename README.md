...
- Primary facades: `FlextTapLdifModelsBase`, `FlextTapLdifCli`, `FlextTapLdifModelsFile`, `FlextTapLdifModelsEntry`, `FlextTapLdifTypes`, `FlextTapLdifModelsRecord` (+9 more)
...
2. Confirm parent MRO chain via `pyproject.toml` `dependencies` filtered by `flext-*` (excluding `flext-tap-ldif` self).
...
- Public extensions exposed by this project: `FlextTapLdifModelsBase`, `FlextTapLdifCli`, `FlextTapLdifModelsFile`, `FlextTapLdifModelsEntry`, `FlextTapLdifTypes`, `FlextTapLdifModelsRecord` (+9 more).
