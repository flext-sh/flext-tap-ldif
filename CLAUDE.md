# flext-tap-ldif - FLEXT Singer Ecosystem
...
**FLEXT-Tap-LDIF** is the enterprise LDIF data extraction tap with Singer protocol integration for the FLEXT ecosystem.
...
- ❌ Direct LDIF parsing (use flext-ldif)
